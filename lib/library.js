...
const getPageMetaData = (post) => {
  ...
  return {
    ...
    isRelevant: post.properties.isRelevant.checkbox,
    courses: getTags(post.properties.Courses_Tags.multi_select),
    institutions: getTags(post.properties.Institutions_Tags.multi_select),
